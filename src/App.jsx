...
const AppRoutes = () => {
  ...
  // ------------------- TEMPORARY OVERRIDE -------------------
  // To bypass authentication and get into the app for development/debugging.
  // Set this to true to force the app to render the main content.
  ...
  // Authenticated (or bypassed): show app UI
  return (
